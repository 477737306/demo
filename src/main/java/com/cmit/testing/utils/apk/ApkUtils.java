...
import com.cmit.testing.entity.app.ImpliedFeature;
...
/**
 * @author XieZuLiang
 * @description TODO apk工具类。封装了获取Apk信息的方法。
 * @date 2018/8/30 0030 下午 2:21.
 */
public class ApkUtils {
    ...
    public ApkInfo getApkInfo(String apkPath) throws Exception {
        ...
        try {
            ...
            ins = new InputStreamReader(is, "utf8");
...
//			System.out.println(source);
    ...
    private String getPropertyInQuote(String source) {
        ...
        try
        {
            value = source.substring(index,source.indexOf('\'',index));
        }
        catch(Exception e)
        {
