...
public class GridNodeLocator {
    ...
    public static void main(String[] args) throws IOException {
        ...
        RemoteWebDriver webDriver = new RemoteWebDriver(new URL("http://localhost:4444/wd/hub"), capability);
        String hostAddress = new GridNodeLocator("localhost", "4444").locate(webDriver);
